...
namespace ClosetApp.Controllers
{
    public class AccessoriesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "AccessoryID,Name,Type,Color,SeasonID,OccasionID,Photo")] Accessory accessory)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "AccessoryID,Name,Type,Color,SeasonID,OccasionID,Photo")] Accessory accessory)
        {
            if (ModelState.IsValid)
            {
