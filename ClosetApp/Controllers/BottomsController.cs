...
namespace ClosetApp.Controllers
{
    public class BottomsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "BottomID,Name,Type,Color,SeasonID,OccasionID,Photo")] Bottom bottom)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "BottomID,Name,Type,Color,SeasonID,OccasionID,Photo")] Bottom bottom)
        {
            if (ModelState.IsValid)
            {
