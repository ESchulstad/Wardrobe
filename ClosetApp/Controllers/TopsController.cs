...
namespace ClosetApp.Controllers
{
    public class TopsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "TopID,Name,Type,Color,SeasonID,OccasionID,Photo")] Top top)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "TopID,Name,Type,Color,SeasonID,OccasionID,Photo")] Top top)
        {
            if (ModelState.IsValid)
            {
